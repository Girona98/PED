...
class TListaCalendario{
    ...
    public:
        ...
        TListaCalendario operator+(const TListaCalendario&)const;        //sobrecarga del operador suma
        ...
        bool Buscar(const TCalendario&)const;                            //devuelve true si el calendario esta en la lista
